...
`,rv={};rv=JSON.parse('{"name":"week-planner-card","version":"1.14.1","description":"Custom Home Assistant card to display events for a number of days from one or several calendars.","source":"src/index.js","module":"dist/week-planner-card.js","targets":{"module":{"includeNodeModules":true,"optimize":true}},"scripts":{"watch":"parcel watch","build":"parcel build"},"repository":{"type":"git","url":"git+https://github.com/FamousWolf/week-planner-card.git"},"keywords":["lovelace"],"author":"Rudy Gnodde","licence":"MIT","bugs":{"url":"https://github.com/FamousWolf/week-planner-card/issues"},"homepage":"https://github.com/FamousWolf/week-planner-card","devDependencies":{"@parcel/optimizer-data-url":"^2.12.0","@parcel/transformer-inline-string":"^2.11.0","parcel":"^2.16.3","svgo":"^3.3.2"},"dependencies":{"lit":"^3.1.2","luxon":"^3.4.4"}}'),customElements.define("week-planner-card",class extends es{static styles=i7;_initialized=!1;_loading=0;_events={};_calendarEvents={};_calendars;_numberOfDays;_numberOfDaysIsMonth;_updateInterval;_noCardBackground;_eventBackground;_compact;_language;_weather;_dateFormat;_timeFormat;_multiDayTimeFormat;_multiDayMode;_locationLink;_startDate;_hideWeekend;_startingDay;_startingDayOffset;_weatherForecast=null;_showLocation;_hidePastEvents;_hideAllDayEvents;_hideDaysWithoutEvents;_hideTodayWithoutEvents;_filter;_filterText;_replaceTitleText;_combineSimilarEvents;_showLegend;_legendToggle;_actions;_columns;_loader;_showNavigation;_navigationOffset=0;_updateEventsTimeouts=[];_calendarErrors=[];static getConfigElement(){return document.createElement("week-planner-card-editor")}static getStubConfig(){return{calendars:[],days:7,startingDay:"today",startingDayOffset:0,showWeekDayText:!0,hideWeekend:!1,noCardBackground:!1,compact:!1,weather:{showCondition:!0,showTemperature:!1,showLowTemperature:!1,roundTemperature:!1,useTwiceDaily:!1},locale:"en",showLocation:!1,hidePastEvents:!1,hideDaysWithoutEvents:!1,hideTodayWithoutEvents:!1,combineSimilarEvents:!1,showLegend:!1}}static get properties(){return{_days:{type:Array},_config:{type:Object},_error:{type:String},_currentEventDetails:{type:Object},_hideCalendars:{type:Array},_showCreateEventDialog:{type:Object},_showEditEventDialog:{type:Object},_editFormData:{type:Object}}}setConfig(e){if(this._config=e,!e.calendars)throw Error("No calendars are configured");this._numberOfDaysIsMonth=this._isNumberOfDaysMonth(e.days??7),this._title=e.title??null,this._calendars=e.calendars,this._defaultCalendar=e.defaultCalendar??null,this._weather=this._getWeatherConfig(e.weather),this._numberOfDays=this._getNumberOfDays(e.days??7),this._hideWeekend=e.hideWeekend??!1,this._showNavigation=e.showNavigation??!1,this._startingDay=e.startingDay??"today",this._startingDayOffset=e.startingDayOffset??0,this._showWeekDayText=e.showWeekDayText??!0,this._startDate=this._getStartDate(),this._updateInterval=e.updateInterval??60,this._noCardBackground=e.noCardBackground??!1,this._eventBackground=e.eventBackground??"var(--card-background-color, inherit)",this._compact=e.compact??!1,this._dayFormat=e.dayFormat??null,this._dateFormat=e.dateFormat??"cccc d LLLL yyyy",this._timeFormat=e.timeFormat??"HH:mm",this._multiDayTimeFormat=e._multiDayTimeFormat??"d LLL HH:mm",this._multiDayMode=e.multiDayMode??"default",this._locationLink=e.locationLink??"https://www.google.com/maps/search/?api=1&query=",this._showTitle=e.showTitle??!0,this._showDescription=e.showDescription??!1,this._showLocation=e.showLocation??!1,this._showTime=e.showTime??!1,this._showDayName=e.showDayName??!1,this._showDate=e.showDate??!1,this._showCalendarName=e.showCalendarName??!1,this._showWeather=e.showWeather??!0,this._showCurrentWeather=e.showCurrentWeather??!1,this._hidePastEvents=e.hidePastEvents??!1,this._hideAllDayEvents=e.hideAllDayEvents??!1,this._hideDaysWithoutEvents=e.hideDaysWithoutEvents??!1,this._hideTodayWithoutEvents=e.hideTodayWithoutEvents??!1,this._filter=e.filter??!1,this._filterText=e.filterText??!1,this._replaceTitleText=e.replaceTitleText??!1,this._combineSimilarEvents=e.combineSimilarEvents??!1,this._showLegend=e.showLegend??!1,this._legendToggle=e.legendToggle??!1,this._actions=e.actions??!1,this._columns=e.columns??{},this._maxEvents=e.maxEvents??!1,this._maxDayEvents=e.maxDayEvents??!1,this._hideCalendars=(e.calendars||[]).reduce((e,t)=>(t.initiallyHidden&&t.entity&&e.push(t.entity),e),[]),e.locale&&(eh.Settings.defaultLocale=e.locale),this._language=Object.assign({},{fullDay:"Entire day",noEvents:"No events",moreEvents:"More events",today:"Today",tomorrow:"Tomorrow",yesterday:"Yesterday",sunday:eh.Info.weekdays("long")[6],monday:eh.Info.weekdays("long")[0],tuesday:eh.Info.weekdays("long")[1],wednesday:eh.Info.weekdays("long")[2],thursday:eh.Info.weekdays("long")[3],friday:eh.Info.weekdays("long")[4],saturday:eh.Info.weekdays("long")[5]},e.texts??{})}_isNumberOfDaysMonth(e){return"month"===String(e).toLowerCase().trim()}_getWeatherConfig(e){if(!e||"string"!=typeof e&&"object"!=typeof e)return null;let t={entity:null,showCondition:!0,showTemperature:!1,showLowTemperature:!1,roundTemperature:!1};return("string"==typeof e?t.entity=e:Object.assign(t,e),t.hasOwnProperty("entity")&&null!==t.entity)?t:null}render(){this._loader||(this._loader=this._getLoader()),this._initialized||(this._initialized=!0,this._waitForHassAndConfig());let e=[];this._noCardBackground&&e.push("nobackground"),this._compact&&e.push("compact");let t=["--event-background-color: "+this._eventBackground+";"];return this._columns.extraLarge&&t.push("--days-columns: "+this._columns.extraLarge+";"),this._columns.large&&t.push("--days-columns-lg: "+this._columns.large+";"),this._columns.medium&&t.push("--days-columns-md: "+this._columns.medium+";"),this._columns.small&&t.push("--days-columns-sm: "+this._columns.small+";"),this._columns.extraSmall&&t.push("--days-columns-xs: "+this._columns.extraSmall+";"),z`
        ...
        `}_renderHeader(){return this._showLegend||this._showNavigation?z`
            <div class="header">
                ${this._renderNavigation()}
                ${this._renderLegend()}
            </div>
        `:z``}_renderLegend(){return this._showLegend?z`
            <div class="legend">
                <ul>
                    ${this._calendars.map(e=>{if(!e.hideInLegend)return z`
                                <li class="${e.icon?"icon":"noIcon"}${this._legendToggle?" hasToggle":""}${-1===this._hideCalendars.indexOf(e.entity)?"":" hidden"}" style="--legend-calendar-color: ${e.color??"inherit"}" @click="${()=>{this._handleLegendClick(e)}}">
                                    ${e.icon?z`<ha-icon icon="${e.icon}"></ha-icon>`:""}
                                    ${e.name??e.entity}
                                </li>
                            `})}
                </ul>
            </div>
        `:z``}_renderNavigation(){return this._showNavigation?z`
        ...
        `:z``}_renderWeekDays(){if(this._showWeekDayText||!this._days||!this._numberOfDaysIsMonth&&this._numberOfDays<7)return z``;let e=this._days.slice(0,7),t=[this._language.sunday,this._language.monday,this._language.tuesday,this._language.wednesday,this._language.thursday,this._language.friday,this._language.saturday,this._language.sunday];return z`
            ${e.map(e=>z`
                ...
                `)}
        `}_renderDays(){return this._days?z`
            ${this._days.map(e=>e.isOutsideMonth?z`<div class="day ${e.class}"></div>`:this._hideDaysWithoutEvents&&0===e.events.length&&(this._hideTodayWithoutEvents||!this._isToday(e.date))?z``:z`
                    <div class="day ${e.class}" data-date="${e.date.day}" data-weekday="${e.date.weekday}" data-month="${e.date.month}" data-year="${e.date.year}" data-week="${e.date.weekNumber}">
                        <div class="date">
                            ${this._dayFormat?ed(e.date.toFormat(this._dayFormat)):z`
                                    <span class="number">${e.date.day}</span>
                                    ${this._showDayName&&(this._showWeekDayText||!this._numberOfDaysIsMonth&&this._numberOfDays<7)?z`<span class="text">${this._getWeekDayText(e.date)}</span>`:""}
                                `}
                        </div>
                        ${this._showWeather&&e.weather?z`
                                <div class="weather" @click="${this._handleWeatherClick}">
                                    ${this._weather?.showTemperature||this._weather?.showLowTemperature?z`
                                            <div class="temperature">
                                                ${this._weather?.showTemperature?z`
                                                        <span class="high">${e.weather.temperature}</span>
                                                    `:""}
                                                ${this._weather?.showLowTemperature?z`
        ...
        `:z``}_renderEvents(e){let t=[];if(e.events.map(e=>{if(!this._calendarEvents[e])return;let n=Object.assign({},this._calendarEvents[e]),i=[...n.calendars],r=[...n.colors],a=0;for(;a<i.length;)this._hideCalendars.indexOf(i[a])>-1?(i.splice(a,1),r.splice(a,1)):a++;0!==i.length&&(n.calendars=i,n.colors=r,t.push(n))}),0===t.length)return this._renderNoEvents();let n=!1;return this._maxDayEvents>0&&t.length>this._maxDayEvents&&(t.splice(this._maxDayEvents),n=!0),z`
            ${t.map(e=>{let t=[e.colors[0]];return z`
                    ...
                    >
                        ${e.colors.map(e=>t.indexOf(e)>-1?"":(t.push(e),z`
                                <div
                            ...
                            `))}
                        <div class="inner">
                            ${this._showTime?z`<div class="time">
                            ...
                            ${this._showDescription?z`
                                ...
                                `:""}
                            ${this._showLocation&&e.location?z`
                                    <div class="location">
            ...
            ${n?z`
                ...
                `:""}
        `}_renderEventTime(e){return e.multiDay&&"default"!==this._multiDayMode?z`
                ${e.originalStart.toFormat(this._multiDayTimeFormat)}
                ${" - "+e.originalEnd.toFormat(this._multiDayTimeFormat)}
            `:e.fullDay?z`${this._language.fullDay}`:z`
                ${e.start.toFormat(this._timeFormat)}
                ${e.end?" - "+e.end.toFormat(this._timeFormat):""}
            `}_renderNoEvents(){return z`
            <div class="none">
                ${this._language.noEvents}
            </div>
        `}_renderCurrentWeather(){if(!this._showCurrentWeather||!this._weather)return z``;let e=this.hass?.states[this._weather.entity];if(!e)return z``;let t=e.state,n=this._weather.roundTemperature?Math.round(e.attributes.temperature):e.attributes.temperature,i=this.hass.formatEntityAttributeValue(e,"temperature",n);return z`
        ...
        `}_renderEventDetailsDialog(){return this._currentEventDetails?z`
            <ha-dialog
                open
            ...
            >
                <div class="content">
                    ...
                    ${this._currentEventDetails.location?z`
                        ...
                        `:""}
                    ${this._currentEventDetails.description?z`
                            <div class="description">
                                ${ed(this._currentEventDetails.description)}
                            </div>
                        `:""}
                    ${this._currentEventDetails.uid?z`
        ...
        `:z``}_renderEventDetailsDialogHeading(){return z`
        ...
        `}_renderEventDetailsDate(){let e=this._currentEventDetails.originalStart,t=this._currentEventDetails.originalEnd??null;if(null===t)return z`
                ${e.toFormat(this._dateFormat+" "+this._timeFormat)}
            `;if(this._isFullDay(e,t,!0))if(24>=Math.abs(e.diff(t,"hours").toObject().hours))return z`
                    ${e.toFormat(this._dateFormat)}
                `;else{let n=t.minus({seconds:1});return z`
                    ${e.toFormat(this._dateFormat)} - ${n.toFormat(this._dateFormat)}
                `}return this._isSameDay(e,t)?z`
        ...
        `}_renderCreateEventDialog(){if(!this._showCreateEventDialog)return z``;let e=this._showCreateEventDialog.date,t=eh.DateTime.now(),n=e.set({hour:t.hour+1,minute:0,second:0,millisecond:0}),i=n.plus({hours:1}),r=n.toFormat("yyyy-MM-dd'T'HH:mm"),a=i.toFormat("yyyy-MM-dd'T'HH:mm");return z`
            <ha-dialog
                open
        ...
        `}_renderCreateEventDialogHeading(){return z`
            <div class="header_title">
        ...
        `}_renderEditEventDialog(){if(!this._showEditEventDialog||!this._editFormData)return z``;this._showEditEventDialog;let e=this._editFormData;return z`
            <ha-dialog
                open
        ...
        `}_renderEditEventDialogHeading(){return z`
            <div class="header_title">
        ...
        `}_getLoader(){let e=document.createElement("div");return e.className="loader",e.style.display="none",e}_updateLoader(){this._loading>0?this._loader.style.display="inherit":this._loader.style.display="none"}_getWeatherIcon(e,t){if(!e)return null;let n=getComputedStyle(this).getPropertyValue("--weather-icon-"+e).trim();return null!==n&&-1===["","none","inherit"].indexOf(n)?z`<div class="icon" style="background-image: var(--weather-icon-${e})"></div>`:z`
            ...
            <div style="display: flex; flex-direction: column">
                ...
                ${this.addExpansionPanel("Days",z`
                    ...
                    `)}
                ${this.addExpansionPanel("Events",z`
                    ...
                    `)}
                ${this.addExpansionPanel("Date/time formats",z`
                    ...
                    `)}
                ${this.addExpansionPanel("Weather",z`
                    ...
                    `)}
                ${this.addExpansionPanel("Override columns",z`
                    ...
                    `)}
                ${this.addExpansionPanel("Appearance",z`
                ...
                ${this.addExpansionPanel("Texts",z`
                    ...
                    `)}
                ${this.addExpansionPanel("Miscellaneous",z`
                        ${this.addTextField("updateInterval","Override update interval","number")}
                    `)}
            </div>
        `:z``}addTextField(e,t,n,i){return z`
            <ha-textfield
                name="${e}"
                label="${t??e}"
                type="${n??"text"}"
            ...
            />
        `}addEntityPickerField(e,t,n,i){return z`
            <ha-entity-picker
                .hass="${this.hass}"
                name="${e}"
                label="${t??e}"
            ...
            />
        `}addIconPickerField(e,t,n){return z`
            <ha-icon-picker
                .hass="${this.hass}"
                name="${e}"
                label="${t??e}"
                ...
                @value-changed="${this._valueChanged}"
            />
        `}addSelectField(e,t,n,i,r){return z`
            <ha-select
                name="${e}"
                label="${t??e}"
        ...
        `}addBooleanField(e,t,n){return z`
            <ha-formfield
                label="${t??e}"
            >
                <ha-switch
        ...
        `}addExpansionPanel(e,t,n){return z`
            <ha-expansion-panel
                header="${e}"
                .expanded="${n??!1}"
                outlined="true"
